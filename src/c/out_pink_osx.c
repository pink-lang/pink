...
const TypeInfo *typeinfo_table[645] = {
    ...
    [20] = NULL, // Func
    [21] = NULL, // Enum
    [22] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(TypeFieldInfo), .align = alignof(TypeFieldInfo), .name = "TypeFieldInfo", .num_fields = 3, .fields = (TypeFieldInfo[]) {
    ...
    [23] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(TypeInfo), .align = alignof(TypeInfo), .name = "TypeInfo", .num_fields = 8, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(21, TYPE_NONE, TypeKind), .offset = offsetof(TypeInfo, kind)},
        ...
        {"fields", .type = TYPEID(24, TYPE_PTR, TypeFieldInfo *), .offset = offsetof(TypeInfo, fields)},
        {"num_fields", .type = TYPEID(8, TYPE_INT, int), .offset = offsetof(TypeInfo, num_fields)},
    }},
    [24] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(22, TYPE_STRUCT, TypeFieldInfo)},
    [25] = &(TypeInfo){TYPE_CONST, .size = sizeof(TypeInfo const ), .align = alignof(TypeInfo const ), .base = TYPEID(23, TYPE_STRUCT, TypeInfo)},
    [26] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(25, TYPE_CONST, TypeInfo const )},
    [27] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(26, TYPE_PTR, TypeInfo const (*))},
    [28] = NULL, // Func
    [29] = NULL, // Func
    [30] = NULL, // Func
    [31] = NULL, // Func
    [32] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(Any), .align = alignof(Any), .name = "Any", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"ptr", .type = TYPEID(16, TYPE_PTR, void *), .offset = offsetof(Any, ptr)},
        {"type", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(Any, type)},
    }},
    [33] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [4]), .align = alignof(char [4]), .base = TYPEID(3, TYPE_CHAR, char), .count = 4},
    [34] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(3, TYPE_CHAR, char)},
    [35] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [6]), .align = alignof(char [6]), .base = TYPEID(3, TYPE_CHAR, char), .count = 6},
    [36] = NULL, // Enum
    [37] = NULL, // Enum
    [38] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Sym), .align = alignof(src_pink_Sym), .name = "src_pink_Sym", .num_fields = 10, .fields = (TypeFieldInfo[]) {
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Sym, name)},
        {"home_package", .type = TYPEID(40, TYPE_PTR, src_pink_Package *), .offset = offsetof(src_pink_Sym, home_package)},
        {"kind", .type = TYPEID(36, TYPE_NONE, src_pink_SymKind), .offset = offsetof(src_pink_Sym, kind)},
        {"state", .type = TYPEID(37, TYPE_NONE, src_pink_SymState), .offset = offsetof(src_pink_Sym, state)},
        {"reachable", .type = TYPEID(4, TYPE_UCHAR, uchar), .offset = offsetof(src_pink_Sym, reachable)},
        {"decl", .type = TYPEID(50, TYPE_PTR, src_pink_Decl *), .offset = offsetof(src_pink_Sym, decl)},
        {"external_name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Sym, external_name)},
        {"type", .type = TYPEID(52, TYPE_PTR, src_pink_Type *), .offset = offsetof(src_pink_Sym, type)},
        {"val", .type = TYPEID(53, TYPE_UNION, std_Val), .offset = offsetof(src_pink_Sym, val)},
        {"package", .type = TYPEID(40, TYPE_PTR, src_pink_Package *), .offset = offsetof(src_pink_Sym, package)},
    }},
    [39] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Package), .align = alignof(src_pink_Package), .name = "src_pink_Package", .num_fields = 8, .fields = (TypeFieldInfo[]) {
        {"path", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Package, path)},
        {"full_path", .type = TYPEID(139, TYPE_ARRAY, char [256]), .offset = offsetof(src_pink_Package, full_path)},
        {"decls", .type = TYPEID(313, TYPE_PTR, src_pink_Decl (**)), .offset = offsetof(src_pink_Package, decls)},
        {"num_decls", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_Package, num_decls)},
        {"syms_map", .type = TYPEID(41, TYPE_STRUCT, std_Map), .offset = offsetof(src_pink_Package, syms_map)},
        {"syms", .type = TYPEID(48, TYPE_PTR, src_pink_Sym (**)), .offset = offsetof(src_pink_Package, syms)},
    ...
    [40] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(39, TYPE_STRUCT, src_pink_Package)},
    [41] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(std_Map), .align = alignof(std_Map), .name = "std_Map", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"keys", .type = TYPEID(42, TYPE_PTR, ullong *), .offset = offsetof(std_Map, keys)},
        {"vals", .type = TYPEID(42, TYPE_PTR, ullong *), .offset = offsetof(std_Map, vals)},
    ...
    [42] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(13, TYPE_ULLONG, ullong)},
    [43] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(40, TYPE_PTR, src_pink_Package *)},
    [44] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(38, TYPE_STRUCT, src_pink_Sym)},
    [45] = NULL, // Func
    [46] = NULL, // Func
    [47] = NULL, // Func
    [48] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(44, TYPE_PTR, src_pink_Sym *)},
    [49] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Decl), .align = alignof(src_pink_Decl), .name = "src_pink_Decl", .num_fields = 13, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(172, TYPE_NONE, src_pink_DeclKind), .offset = offsetof(src_pink_Decl, kind)},
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Decl, pos)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Decl, name)},
        {"notes", .type = TYPEID(178, TYPE_STRUCT, src_pink_Notes), .offset = offsetof(src_pink_Decl, notes)},
        {"is_incomplete", .type = TYPEID(2, TYPE_BOOL, bool), .offset = offsetof(src_pink_Decl, is_incomplete)},
        {"note", .type = TYPEID(121, TYPE_STRUCT, src_pink_Note), .offset = offsetof(src_pink_Decl, note)},
        {"enum_decl", .type = TYPEID(226, TYPE_STRUCT, src_pink_DeclEnum), .offset = offsetof(src_pink_Decl, enum_decl)},
        {"aggregate", .type = TYPEID(98, TYPE_PTR, src_pink_Aggregate *), .offset = offsetof(src_pink_Decl, aggregate)},
        {"function", .type = TYPEID(227, TYPE_STRUCT, src_pink_DeclFunc), .offset = offsetof(src_pink_Decl, function)},
        {"typedef_decl", .type = TYPEID(228, TYPE_STRUCT, src_pink_DeclTypedef), .offset = offsetof(src_pink_Decl, typedef_decl)},
        {"var_decl", .type = TYPEID(229, TYPE_STRUCT, src_pink_DeclVar), .offset = offsetof(src_pink_Decl, var_decl)},
        {"const_decl", .type = TYPEID(229, TYPE_STRUCT, src_pink_DeclVar), .offset = offsetof(src_pink_Decl, const_decl)},
        {"import_decl", .type = TYPEID(230, TYPE_STRUCT, src_pink_DeclImport), .offset = offsetof(src_pink_Decl, import_decl)},
    }},
    [50] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(49, TYPE_STRUCT, src_pink_Decl)},
    [51] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Type), .align = alignof(src_pink_Type), .name = "src_pink_Type", .num_fields = 10, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(190, TYPE_NONE, src_pink_CompilerTypeKind), .offset = offsetof(src_pink_Type, kind)},
        ...
        {"sym", .type = TYPEID(44, TYPE_PTR, src_pink_Sym *), .offset = offsetof(src_pink_Type, sym)},
        {"base", .type = TYPEID(52, TYPE_PTR, src_pink_Type *), .offset = offsetof(src_pink_Type, base)},
        ...
        {"aggregate", .type = TYPEID(196, TYPE_STRUCT, src_pink_TypeAggregate), .offset = offsetof(src_pink_Type, aggregate)},
        {"function", .type = TYPEID(197, TYPE_STRUCT, src_pink_TypeFunc), .offset = offsetof(src_pink_Type, function)},
    }},
    [52] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(51, TYPE_STRUCT, src_pink_Type)},
    [53] = &(TypeInfo){TYPE_UNION, .size = sizeof(std_Val), .align = alignof(std_Val), .name = "std_Val", .num_fields = 13, .fields = (TypeFieldInfo[]) {
    ...
    [54] = NULL, // No associated type
    [55] = NULL, // No associated type
    [56] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(src_pink_Sym [1024]), .align = alignof(src_pink_Sym [1024]), .base = TYPEID(38, TYPE_STRUCT, src_pink_Sym), .count = 1024},
    [57] = NULL, // Func
    [58] = NULL, // Func
    [59] = NULL, // Func
    [60] = NULL, // Func
    ...
    [65] = NULL, // Func
    [66] = NULL, // Func
    [67] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(34, TYPE_PTR, char *)},
    [68] = NULL, // Func
    [69] = NULL, // Func
    [70] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Operand), .align = alignof(src_pink_Operand), .name = "src_pink_Operand", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(52, TYPE_PTR, src_pink_Type *), .offset = offsetof(src_pink_Operand, type)},
        ...
        {"val", .type = TYPEID(53, TYPE_UNION, std_Val), .offset = offsetof(src_pink_Operand, val)},
    }},
    [71] = NULL, // Func
    [72] = NULL, // Func
    [73] = NULL, // Func
    [74] = NULL, // Func
    [75] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(70, TYPE_STRUCT, src_pink_Operand)},
    [76] = NULL, // Func
    [77] = NULL, // Func
    [78] = NULL, // Func
    [79] = NULL, // Func
    ...
    [82] = NULL, // Func
    [83] = NULL, // Func
    [84] = &(TypeInfo){TYPE_CONST, .size = 0, .align = 0, .base = TYPEID0(1, TYPE_VOID)},
    [85] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID0(84, TYPE_CONST)},
    [86] = NULL, // Func
    [87] = NULL, // Func
    [88] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Expr), .align = alignof(src_pink_Expr), .name = "src_pink_Expr", .num_fields = 23, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(231, TYPE_NONE, src_pink_ExprKind), .offset = offsetof(src_pink_Expr, kind)},
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Expr, pos)},
        {"paren", .type = TYPEID(232, TYPE_STRUCT, src_pink_ExprParen), .offset = offsetof(src_pink_Expr, paren)},
        {"int_lit", .type = TYPEID(233, TYPE_STRUCT, src_pink_ExprIntLit), .offset = offsetof(src_pink_Expr, int_lit)},
        {"float_lit", .type = TYPEID(234, TYPE_STRUCT, src_pink_ExprFloatLit), .offset = offsetof(src_pink_Expr, float_lit)},
        {"str_lit", .type = TYPEID(235, TYPE_STRUCT, src_pink_ExprStrLit), .offset = offsetof(src_pink_Expr, str_lit)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Expr, name)},
        {"sizeof_expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_Expr, sizeof_expr)},
        {"sizeof_type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_Expr, sizeof_type)},
        {"typeof_expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_Expr, typeof_expr)},
        {"typeof_type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_Expr, typeof_type)},
        {"alignof_expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_Expr, alignof_expr)},
        {"alignof_type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_Expr, alignof_type)},
        {"offsetof_field", .type = TYPEID(236, TYPE_STRUCT, src_pink_ExprOffsetofField), .offset = offsetof(src_pink_Expr, offsetof_field)},
        {"compound", .type = TYPEID(237, TYPE_STRUCT, src_pink_ExprCompound), .offset = offsetof(src_pink_Expr, compound)},
        {"cast", .type = TYPEID(238, TYPE_STRUCT, src_pink_ExprCast), .offset = offsetof(src_pink_Expr, cast)},
        {"modify", .type = TYPEID(239, TYPE_STRUCT, src_pink_ExprModify), .offset = offsetof(src_pink_Expr, modify)},
        {"unary", .type = TYPEID(240, TYPE_STRUCT, src_pink_ExprUnary), .offset = offsetof(src_pink_Expr, unary)},
        {"binary", .type = TYPEID(241, TYPE_STRUCT, src_pink_ExprBinary), .offset = offsetof(src_pink_Expr, binary)},
        {"ternary", .type = TYPEID(242, TYPE_STRUCT, src_pink_ExprTernary), .offset = offsetof(src_pink_Expr, ternary)},
        {"call", .type = TYPEID(243, TYPE_STRUCT, src_pink_ExprCall), .offset = offsetof(src_pink_Expr, call)},
        {"index", .type = TYPEID(244, TYPE_STRUCT, src_pink_ExprIndex), .offset = offsetof(src_pink_Expr, index)},
        {"field", .type = TYPEID(245, TYPE_STRUCT, src_pink_ExprField), .offset = offsetof(src_pink_Expr, field)},
    }},
    [89] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(88, TYPE_STRUCT, src_pink_Expr)},
    [90] = NULL, // Func
    [91] = NULL, // Func
    [92] = NULL, // Func
    [93] = NULL, // Func
    [94] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Typespec), .align = alignof(src_pink_Typespec), .name = "src_pink_Typespec", .num_fields = 6, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(223, TYPE_NONE, src_pink_TypespecKind), .offset = offsetof(src_pink_Typespec, kind)},
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Typespec, pos)},
        {"base", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_Typespec, base)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Typespec, name)},
        {"function", .type = TYPEID(224, TYPE_STRUCT, src_pink_TypespecFunc), .offset = offsetof(src_pink_Typespec, function)},
        {"num_elems", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_Typespec, num_elems)},
    }},
    [95] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(94, TYPE_STRUCT, src_pink_Typespec)},
    [96] = NULL, // Func
    [97] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Aggregate), .align = alignof(src_pink_Aggregate), .name = "src_pink_Aggregate", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Aggregate, pos)},
        {"kind", .type = TYPEID(170, TYPE_NONE, src_pink_AggregateKind), .offset = offsetof(src_pink_Aggregate, kind)},
        {"items", .type = TYPEID(320, TYPE_PTR, src_pink_AggregateItem *), .offset = offsetof(src_pink_Aggregate, items)},
        {"num_items", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_Aggregate, num_items)},
    }},
    [98] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(97, TYPE_STRUCT, src_pink_Aggregate)},
    [99] = NULL, // Func
    [100] = NULL, // Func
    [101] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_SrcPos), .align = alignof(src_pink_SrcPos), .name = "src_pink_SrcPos", .num_fields = 2, .fields = (TypeFieldInfo[]) {
    ...
    [103] = NULL, // Func
    [104] = NULL, // Func
    [105] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(53, TYPE_UNION, std_Val)},
    [106] = NULL, // Func
    [107] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtCtx), .align = alignof(src_pink_StmtCtx), .name = "src_pink_StmtCtx", .num_fields = 2, .fields = (TypeFieldInfo[]) {
    ...
    [108] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Label), .align = alignof(src_pink_Label), .name = "src_pink_Label", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Label, name)},
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Label, pos)},
    ...
    [109] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(src_pink_Label [256]), .align = alignof(src_pink_Label [256]), .base = TYPEID(108, TYPE_STRUCT, src_pink_Label), .count = 256},
    [110] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(108, TYPE_STRUCT, src_pink_Label)},
    [111] = NULL, // Func
    [112] = NULL, // Func
    [113] = NULL, // Func
    [114] = NULL, // Func
    [115] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtList), .align = alignof(src_pink_StmtList), .name = "src_pink_StmtList", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_StmtList, pos)},
        {"stmts", .type = TYPEID(118, TYPE_PTR, src_pink_Stmt (**)), .offset = offsetof(src_pink_StmtList, stmts)},
        {"num_stmts", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_StmtList, num_stmts)},
    }},
    [116] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Stmt), .align = alignof(src_pink_Stmt), .name = "src_pink_Stmt", .num_fields = 14, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(247, TYPE_NONE, src_pink_StmtKind), .offset = offsetof(src_pink_Stmt, kind)},
        {"notes", .type = TYPEID(178, TYPE_STRUCT, src_pink_Notes), .offset = offsetof(src_pink_Stmt, notes)},
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Stmt, pos)},
        {"note", .type = TYPEID(121, TYPE_STRUCT, src_pink_Note), .offset = offsetof(src_pink_Stmt, note)},
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_Stmt, expr)},
        {"decl", .type = TYPEID(50, TYPE_PTR, src_pink_Decl *), .offset = offsetof(src_pink_Stmt, decl)},
        {"if_stmt", .type = TYPEID(248, TYPE_STRUCT, src_pink_StmtIf), .offset = offsetof(src_pink_Stmt, if_stmt)},
        {"while_stmt", .type = TYPEID(249, TYPE_STRUCT, src_pink_StmtWhile), .offset = offsetof(src_pink_Stmt, while_stmt)},
        {"for_stmt", .type = TYPEID(250, TYPE_STRUCT, src_pink_StmtFor), .offset = offsetof(src_pink_Stmt, for_stmt)},
        {"switch_stmt", .type = TYPEID(251, TYPE_STRUCT, src_pink_StmtSwitch), .offset = offsetof(src_pink_Stmt, switch_stmt)},
        {"block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_Stmt, block)},
        {"assign", .type = TYPEID(252, TYPE_STRUCT, src_pink_StmtAssign), .offset = offsetof(src_pink_Stmt, assign)},
        {"init", .type = TYPEID(253, TYPE_STRUCT, src_pink_StmtInit), .offset = offsetof(src_pink_Stmt, init)},
        {"label", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Stmt, label)},
    }},
    [117] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(116, TYPE_STRUCT, src_pink_Stmt)},
    [118] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(117, TYPE_PTR, src_pink_Stmt *)},
    [119] = NULL, // Func
    [120] = NULL, // Func
    [121] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Note), .align = alignof(src_pink_Note), .name = "src_pink_Note", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Note, pos)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_Note, name)},
        {"args", .type = TYPEID(123, TYPE_PTR, src_pink_NoteArg *), .offset = offsetof(src_pink_Note, args)},
        {"num_args", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_Note, num_args)},
    }},
    [122] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_NoteArg), .align = alignof(src_pink_NoteArg), .name = "src_pink_NoteArg", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_NoteArg, pos)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_NoteArg, name)},
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_NoteArg, expr)},
    }},
    [123] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(122, TYPE_STRUCT, src_pink_NoteArg)},
    [124] = NULL, // Func
    [125] = NULL, // Func
    [126] = NULL, // Func
    [127] = NULL, // Enum
    ...
    [137] = NULL, // Func
    [138] = NULL, // Func
    [139] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [256]), .align = alignof(char [256]), .base = TYPEID(3, TYPE_CHAR, char), .count = 256},
    [140] = NULL, // Func
    [141] = NULL, // Func
    [142] = NULL, // Func
    [143] = NULL, // Func
    [144] = NULL, // Func
    [145] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_CompoundField), .align = alignof(src_pink_CompoundField), .name = "src_pink_CompoundField", .num_fields = 5, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(146, TYPE_NONE, src_pink_CompoundFieldKind), .offset = offsetof(src_pink_CompoundField, kind)},
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_CompoundField, pos)},
        {"init", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_CompoundField, init)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_CompoundField, name)},
        {"index", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_CompoundField, index)},
    }},
    [146] = NULL, // Enum
    ...
    [154] = NULL, // Func
    [155] = NULL, // Func
    [156] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_SwitchCasePattern), .align = alignof(src_pink_SwitchCasePattern), .name = "src_pink_SwitchCasePattern", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"start", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_SwitchCasePattern, start)},
        {"end", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_SwitchCasePattern, end)},
    }},
    [157] = NULL, // Func
    [158] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_SwitchCase), .align = alignof(src_pink_SwitchCase), .name = "src_pink_SwitchCase", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"patterns", .type = TYPEID(159, TYPE_PTR, src_pink_SwitchCasePattern *), .offset = offsetof(src_pink_SwitchCase, patterns)},
        ...
        {"block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_SwitchCase, block)},
    }},
    [159] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(156, TYPE_STRUCT, src_pink_SwitchCasePattern)},
    [160] = NULL, // Func
    [161] = NULL, // Func
    [162] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_EnumItem), .align = alignof(src_pink_EnumItem), .name = "src_pink_EnumItem", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_EnumItem, pos)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_EnumItem, name)},
        {"init", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_EnumItem, init)},
    }},
    [163] = NULL, // Func
    [164] = NULL, // Func
    [165] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_AggregateItem), .align = alignof(src_pink_AggregateItem), .name = "src_pink_AggregateItem", .num_fields = 6, .fields = (TypeFieldInfo[]) {
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_AggregateItem, pos)},
        {"kind", .type = TYPEID(166, TYPE_NONE, src_pink_AggregateItemKind), .offset = offsetof(src_pink_AggregateItem, kind)},
        ...
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_AggregateItem, type)},
        {"subaggregate", .type = TYPEID(98, TYPE_PTR, src_pink_Aggregate *), .offset = offsetof(src_pink_AggregateItem, subaggregate)},
    }},
    [166] = NULL, // Enum
    ...
    [172] = NULL, // Enum
    [173] = NULL, // Func
    [174] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_FuncParam), .align = alignof(src_pink_FuncParam), .name = "src_pink_FuncParam", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_FuncParam, pos)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_FuncParam, name)},
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_FuncParam, type)},
    }},
    [175] = NULL, // Func
    [176] = NULL, // Func
    [177] = NULL, // Func
    [178] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Notes), .align = alignof(src_pink_Notes), .name = "src_pink_Notes", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"notes", .type = TYPEID(179, TYPE_PTR, src_pink_Note *), .offset = offsetof(src_pink_Notes, notes)},
        {"num_notes", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_Notes, num_notes)},
    }},
    [179] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(121, TYPE_STRUCT, src_pink_Note)},
    [180] = NULL, // Func
    [181] = NULL, // Func
    [182] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Decls), .align = alignof(src_pink_Decls), .name = "src_pink_Decls", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"decls", .type = TYPEID(313, TYPE_PTR, src_pink_Decl (**)), .offset = offsetof(src_pink_Decls, decls)},
        {"num_decls", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_Decls, num_decls)},
    }},
    [183] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(182, TYPE_STRUCT, src_pink_Decls)},
    [184] = NULL, // Func
    [185] = NULL, // Enum
    [186] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char const (*[3])), .align = alignof(char const (*[3])), .base = TYPEID(18, TYPE_PTR, char const (*)), .count = 3},
    [187] = NULL, // Enum
    [188] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char const (*[2])), .align = alignof(char const (*[2])), .base = TYPEID(18, TYPE_PTR, char const (*)), .count = 2},
    [189] = NULL, // Func
    [190] = NULL, // Enum
    [191] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_TypeMetrics), .align = alignof(src_pink_TypeMetrics), .name = "src_pink_TypeMetrics", .num_fields = 4, .fields = (TypeFieldInfo[]) {
    ...
    [192] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(src_pink_TypeMetrics [25]), .align = alignof(src_pink_TypeMetrics [25]), .base = TYPEID(191, TYPE_STRUCT, src_pink_TypeMetrics), .count = 25},
    [193] = NULL, // Func
    [194] = NULL, // Func
    [195] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_TypeField), .align = alignof(src_pink_TypeField), .name = "src_pink_TypeField", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_TypeField, name)},
        {"type", .type = TYPEID(52, TYPE_PTR, src_pink_Type *), .offset = offsetof(src_pink_TypeField, type)},
        {"offset", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_TypeField, offset)},
    }},
    [196] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_TypeAggregate), .align = alignof(src_pink_TypeAggregate), .name = "src_pink_TypeAggregate", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"fields", .type = TYPEID(199, TYPE_PTR, src_pink_TypeField *), .offset = offsetof(src_pink_TypeAggregate, fields)},
        {"num_fields", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_TypeAggregate, num_fields)},
    }},
    [197] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_TypeFunc), .align = alignof(src_pink_TypeFunc), .name = "src_pink_TypeFunc", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"params", .type = TYPEID(200, TYPE_PTR, src_pink_Type (**)), .offset = offsetof(src_pink_TypeFunc, params)},
        ...
        {"ret", .type = TYPEID(52, TYPE_PTR, src_pink_Type *), .offset = offsetof(src_pink_TypeFunc, ret)},
    }},
    [198] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(191, TYPE_STRUCT, src_pink_TypeMetrics)},
    [199] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(195, TYPE_STRUCT, src_pink_TypeField)},
    [200] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(52, TYPE_PTR, src_pink_Type *)},
    [201] = NULL, // No associated type
    [202] = NULL, // Func
    [203] = NULL, // Func
    [204] = NULL, // Func
    [205] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char const (*[25])), .align = alignof(char const (*[25])), .base = TYPEID(18, TYPE_PTR, char const (*)), .count = 25},
    [206] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [5]), .align = alignof(char [5]), .base = TYPEID(3, TYPE_CHAR, char), .count = 5},
    [207] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [7]), .align = alignof(char [7]), .base = TYPEID(3, TYPE_CHAR, char), .count = 7},
    [208] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(int [25]), .align = alignof(int [25]), .base = TYPEID(8, TYPE_INT, int), .count = 25},
    [209] = NULL, // Func
    [210] = NULL, // Func
    [211] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_CachedArrayType), .align = alignof(src_pink_CachedArrayType), .name = "src_pink_CachedArrayType", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(52, TYPE_PTR, src_pink_Type *), .offset = offsetof(src_pink_CachedArrayType, type)},
        {"next", .type = TYPEID(472, TYPE_PTR, src_pink_CachedArrayType *), .offset = offsetof(src_pink_CachedArrayType, next)},
    }},
    [212] = NULL, // Func
    [213] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_CachedFuncType), .align = alignof(src_pink_CachedFuncType), .name = "src_pink_CachedFuncType", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(52, TYPE_PTR, src_pink_Type *), .offset = offsetof(src_pink_CachedFuncType, type)},
        {"next", .type = TYPEID(476, TYPE_PTR, src_pink_CachedFuncType *), .offset = offsetof(src_pink_CachedFuncType, next)},
    }},
    [214] = NULL, // Func
    [215] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(199, TYPE_PTR, src_pink_TypeField *)},
    [216] = NULL, // Func
    [217] = NULL, // Func
    [218] = NULL, // Func
    [219] = NULL, // Func
    ...
    [222] = NULL, // Func
    [223] = NULL, // Enum
    [224] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_TypespecFunc), .align = alignof(src_pink_TypespecFunc), .name = "src_pink_TypespecFunc", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"args", .type = TYPEID(311, TYPE_PTR, src_pink_Typespec (**)), .offset = offsetof(src_pink_TypespecFunc, args)},
        ...
        {"ret", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_TypespecFunc, ret)},
    }},
    [225] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ImportItem), .align = alignof(src_pink_ImportItem), .name = "src_pink_ImportItem", .num_fields = 2, .fields = (TypeFieldInfo[]) {
    ...
    [226] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_DeclEnum), .align = alignof(src_pink_DeclEnum), .name = "src_pink_DeclEnum", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_DeclEnum, type)},
        {"items", .type = TYPEID(318, TYPE_PTR, src_pink_EnumItem *), .offset = offsetof(src_pink_DeclEnum, items)},
        {"num_items", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_DeclEnum, num_items)},
    }},
    [227] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_DeclFunc), .align = alignof(src_pink_DeclFunc), .name = "src_pink_DeclFunc", .num_fields = 5, .fields = (TypeFieldInfo[]) {
        {"params", .type = TYPEID(324, TYPE_PTR, src_pink_FuncParam *), .offset = offsetof(src_pink_DeclFunc, params)},
        {"num_params", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_DeclFunc, num_params)},
        {"ret_type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_DeclFunc, ret_type)},
        {"has_varargs", .type = TYPEID(2, TYPE_BOOL, bool), .offset = offsetof(src_pink_DeclFunc, has_varargs)},
        {"block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_DeclFunc, block)},
    }},
    [228] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_DeclTypedef), .align = alignof(src_pink_DeclTypedef), .name = "src_pink_DeclTypedef", .num_fields = 1, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_DeclTypedef, type)},
    }},
    [229] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_DeclVar), .align = alignof(src_pink_DeclVar), .name = "src_pink_DeclVar", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_DeclVar, type)},
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_DeclVar, expr)},
    }},
    [230] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_DeclImport), .align = alignof(src_pink_DeclImport), .name = "src_pink_DeclImport", .num_fields = 6, .fields = (TypeFieldInfo[]) {
        ...
        {"items", .type = TYPEID(328, TYPE_PTR, src_pink_ImportItem *), .offset = offsetof(src_pink_DeclImport, items)},
        {"num_items", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_DeclImport, num_items)},
    }},
    [231] = NULL, // Enum
    [232] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprParen), .align = alignof(src_pink_ExprParen), .name = "src_pink_ExprParen", .num_fields = 1, .fields = (TypeFieldInfo[]) {
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprParen, expr)},
    }},
    [233] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprIntLit), .align = alignof(src_pink_ExprIntLit), .name = "src_pink_ExprIntLit", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"val", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_ExprIntLit, val)},
        {"mod", .type = TYPEID(255, TYPE_NONE, src_pink_TokenMod), .offset = offsetof(src_pink_ExprIntLit, mod)},
        {"suffix", .type = TYPEID(256, TYPE_NONE, src_pink_TokenSuffix), .offset = offsetof(src_pink_ExprIntLit, suffix)},
    }},
    [234] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprFloatLit), .align = alignof(src_pink_ExprFloatLit), .name = "src_pink_ExprFloatLit", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        ...
        {"suffix", .type = TYPEID(256, TYPE_NONE, src_pink_TokenSuffix), .offset = offsetof(src_pink_ExprFloatLit, suffix)},
    }},
    [235] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprStrLit), .align = alignof(src_pink_ExprStrLit), .name = "src_pink_ExprStrLit", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"val", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_ExprStrLit, val)},
        {"mod", .type = TYPEID(255, TYPE_NONE, src_pink_TokenMod), .offset = offsetof(src_pink_ExprStrLit, mod)},
    }},
    [236] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprOffsetofField), .align = alignof(src_pink_ExprOffsetofField), .name = "src_pink_ExprOffsetofField", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_ExprOffsetofField, type)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_ExprOffsetofField, name)},
    }},
    [237] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprCompound), .align = alignof(src_pink_ExprCompound), .name = "src_pink_ExprCompound", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_ExprCompound, type)},
        {"fields", .type = TYPEID(339, TYPE_PTR, src_pink_CompoundField *), .offset = offsetof(src_pink_ExprCompound, fields)},
        {"num_fields", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_ExprCompound, num_fields)},
    }},
    [238] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprCast), .align = alignof(src_pink_ExprCast), .name = "src_pink_ExprCast", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_ExprCast, type)},
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprCast, expr)},
    }},
    [239] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprModify), .align = alignof(src_pink_ExprModify), .name = "src_pink_ExprModify", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"op", .type = TYPEID(127, TYPE_NONE, src_pink_TokenKind), .offset = offsetof(src_pink_ExprModify, op)},
        {"post", .type = TYPEID(2, TYPE_BOOL, bool), .offset = offsetof(src_pink_ExprModify, post)},
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprModify, expr)},
    }},
    [240] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprUnary), .align = alignof(src_pink_ExprUnary), .name = "src_pink_ExprUnary", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"op", .type = TYPEID(127, TYPE_NONE, src_pink_TokenKind), .offset = offsetof(src_pink_ExprUnary, op)},
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprUnary, expr)},
    }},
    [241] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprBinary), .align = alignof(src_pink_ExprBinary), .name = "src_pink_ExprBinary", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"op", .type = TYPEID(127, TYPE_NONE, src_pink_TokenKind), .offset = offsetof(src_pink_ExprBinary, op)},
        {"left", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprBinary, left)},
        {"right", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprBinary, right)},
    }},
    [242] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprTernary), .align = alignof(src_pink_ExprTernary), .name = "src_pink_ExprTernary", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"cond", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprTernary, cond)},
        {"then_expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprTernary, then_expr)},
        {"else_expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprTernary, else_expr)},
    }},
    [243] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprCall), .align = alignof(src_pink_ExprCall), .name = "src_pink_ExprCall", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprCall, expr)},
        {"args", .type = TYPEID(342, TYPE_PTR, src_pink_Expr (**)), .offset = offsetof(src_pink_ExprCall, args)},
        {"num_args", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_ExprCall, num_args)},
    }},
    [244] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprIndex), .align = alignof(src_pink_ExprIndex), .name = "src_pink_ExprIndex", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprIndex, expr)},
        {"index", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprIndex, index)},
    }},
    [245] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ExprField), .align = alignof(src_pink_ExprField), .name = "src_pink_ExprField", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ExprField, expr)},
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_ExprField, name)},
    }},
    [246] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_ElseIf), .align = alignof(src_pink_ElseIf), .name = "src_pink_ElseIf", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"cond", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_ElseIf, cond)},
        {"block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_ElseIf, block)},
    }},
    [247] = NULL, // Enum
    [248] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtIf), .align = alignof(src_pink_StmtIf), .name = "src_pink_StmtIf", .num_fields = 6, .fields = (TypeFieldInfo[]) {
        {"init", .type = TYPEID(117, TYPE_PTR, src_pink_Stmt *), .offset = offsetof(src_pink_StmtIf, init)},
        {"cond", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_StmtIf, cond)},
        {"then_block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_StmtIf, then_block)},
        {"elseifs", .type = TYPEID(356, TYPE_PTR, src_pink_ElseIf *), .offset = offsetof(src_pink_StmtIf, elseifs)},
        {"num_elseifs", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_StmtIf, num_elseifs)},
        {"else_block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_StmtIf, else_block)},
    }},
    [249] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtWhile), .align = alignof(src_pink_StmtWhile), .name = "src_pink_StmtWhile", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"cond", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_StmtWhile, cond)},
        {"block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_StmtWhile, block)},
    }},
    [250] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtFor), .align = alignof(src_pink_StmtFor), .name = "src_pink_StmtFor", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"init", .type = TYPEID(117, TYPE_PTR, src_pink_Stmt *), .offset = offsetof(src_pink_StmtFor, init)},
        {"cond", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_StmtFor, cond)},
        {"next", .type = TYPEID(117, TYPE_PTR, src_pink_Stmt *), .offset = offsetof(src_pink_StmtFor, next)},
        {"block", .type = TYPEID(115, TYPE_STRUCT, src_pink_StmtList), .offset = offsetof(src_pink_StmtFor, block)},
    }},
    [251] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtSwitch), .align = alignof(src_pink_StmtSwitch), .name = "src_pink_StmtSwitch", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_StmtSwitch, expr)},
        {"cases", .type = TYPEID(360, TYPE_PTR, src_pink_SwitchCase *), .offset = offsetof(src_pink_StmtSwitch, cases)},
        {"num_cases", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(src_pink_StmtSwitch, num_cases)},
    }},
    [252] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtAssign), .align = alignof(src_pink_StmtAssign), .name = "src_pink_StmtAssign", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"op", .type = TYPEID(127, TYPE_NONE, src_pink_TokenKind), .offset = offsetof(src_pink_StmtAssign, op)},
        {"left", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_StmtAssign, left)},
        {"right", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_StmtAssign, right)},
    }},
    [253] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_StmtInit), .align = alignof(src_pink_StmtInit), .name = "src_pink_StmtInit", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"name", .type = TYPEID(18, TYPE_PTR, char const (*)), .offset = offsetof(src_pink_StmtInit, name)},
        {"type", .type = TYPEID(95, TYPE_PTR, src_pink_Typespec *), .offset = offsetof(src_pink_StmtInit, type)},
        {"expr", .type = TYPEID(89, TYPE_PTR, src_pink_Expr *), .offset = offsetof(src_pink_StmtInit, expr)},
    }},
    [254] = NULL, // Func
    [255] = NULL, // Enum
    [256] = NULL, // Enum
    [257] = NULL, // Incomplete array type
    [258] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [1]), .align = alignof(char [1]), .base = TYPEID(3, TYPE_CHAR, char), .count = 1},
    [259] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [2]), .align = alignof(char [2]), .base = TYPEID(3, TYPE_CHAR, char), .count = 2},
    [260] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [3]), .align = alignof(char [3]), .base = TYPEID(3, TYPE_CHAR, char), .count = 3},
    [261] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char const (*[7])), .align = alignof(char const (*[7])), .base = TYPEID(18, TYPE_PTR, char const (*)), .count = 7},
    [262] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [8]), .align = alignof(char [8]), .base = TYPEID(3, TYPE_CHAR, char), .count = 8},
    [263] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char const (*[54])), .align = alignof(char const (*[54])), .base = TYPEID(18, TYPE_PTR, char const (*)), .count = 54},
    [264] = NULL, // Func
    [265] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(src_pink_TokenKind [54]), .align = alignof(src_pink_TokenKind [54]), .base = TYPEID(127, TYPE_NONE, src_pink_TokenKind), .count = 54},
    [266] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [10]), .align = alignof(char [10]), .base = TYPEID(3, TYPE_CHAR, char), .count = 10},
    [267] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(src_pink_Token), .align = alignof(src_pink_Token), .name = "src_pink_Token", .num_fields = 10, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(127, TYPE_NONE, src_pink_TokenKind), .offset = offsetof(src_pink_Token, kind)},
        {"mod", .type = TYPEID(255, TYPE_NONE, src_pink_TokenMod), .offset = offsetof(src_pink_Token, mod)},
        {"suffix", .type = TYPEID(256, TYPE_NONE, src_pink_TokenSuffix), .offset = offsetof(src_pink_Token, suffix)},
        {"pos", .type = TYPEID(101, TYPE_STRUCT, src_pink_SrcPos), .offset = offsetof(src_pink_Token, pos)},
    ...
    [270] = NULL, // Func
    [271] = NULL, // Func
    [272] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(uchar [256]), .align = alignof(uchar [256]), .base = TYPEID(4, TYPE_UCHAR, uchar), .count = 256},
    [273] = NULL, // Func
    [274] = NULL, // Func
    [275] = NULL, // Func
    [276] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char const (*[256])), .align = alignof(char const (*[256])), .base = TYPEID(18, TYPE_PTR, char const (*)), .count = 256},
    [277] = NULL, // Func
    [278] = NULL, // Func
    [279] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [909]), .align = alignof(char [909]), .base = TYPEID(3, TYPE_CHAR, char), .count = 909},
    [280] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [1513]), .align = alignof(char [1513]), .base = TYPEID(3, TYPE_CHAR, char), .count = 1513},
    [281] = NULL, // Func
    [282] = NULL, // Func
    [283] = NULL, // Func
    [284] = NULL, // Func
    ...
    [292] = NULL, // Func
    [293] = NULL, // Func
    [294] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [11]), .align = alignof(char [11]), .base = TYPEID(3, TYPE_CHAR, char), .count = 11},
    [295] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [12]), .align = alignof(char [12]), .base = TYPEID(3, TYPE_CHAR, char), .count = 12},
    [296] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [9]), .align = alignof(char [9]), .base = TYPEID(3, TYPE_CHAR, char), .count = 9},
    [297] = NULL, // Func
    [298] = NULL, // Func
    [299] = NULL, // Func
    [300] = NULL, // Func
    [301] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(std_Arena), .align = alignof(std_Arena), .name = "std_Arena", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"ptr", .type = TYPEID(34, TYPE_PTR, char *), .offset = offsetof(std_Arena, ptr)},
        {"end", .type = TYPEID(34, TYPE_PTR, char *), .offset = offsetof(std_Arena, end)},
        {"blocks", .type = TYPEID(67, TYPE_PTR, char (**)), .offset = offsetof(std_Arena, blocks)},
    }},
    [302] = NULL, // Func
    [303] = NULL, // Func
    [304] = NULL, // Func
    ...
    [309] = NULL, // Func
    [310] = NULL, // Func
    [311] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(95, TYPE_PTR, src_pink_Typespec *)},
    [312] = NULL, // Func
    [313] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(50, TYPE_PTR, src_pink_Decl *)},
    [314] = NULL, // Func
    [315] = NULL, // Func
    [316] = NULL, // Func
    [317] = NULL, // Func
    [318] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(162, TYPE_STRUCT, src_pink_EnumItem)},
    [319] = NULL, // Func
    [320] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(165, TYPE_STRUCT, src_pink_AggregateItem)},
    [321] = NULL, // Func
    [322] = NULL, // Func
    [323] = NULL, // Func
    [324] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(174, TYPE_STRUCT, src_pink_FuncParam)},
    [325] = NULL, // Func
    [326] = NULL, // Func
    [327] = NULL, // Func
    [328] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(225, TYPE_STRUCT, src_pink_ImportItem)},
    [329] = NULL, // Func
    [330] = NULL, // Func
    [331] = NULL, // Func
    [332] = NULL, // Func
    ...
    [337] = NULL, // Func
    [338] = NULL, // Func
    [339] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(145, TYPE_STRUCT, src_pink_CompoundField)},
    [340] = NULL, // Func
    [341] = NULL, // Func
    [342] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(89, TYPE_PTR, src_pink_Expr *)},
    [343] = NULL, // Func
    [344] = NULL, // Func
    [345] = NULL, // Func
    [346] = NULL, // Func
    ...
    [354] = NULL, // Func
    [355] = NULL, // Func
    [356] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(246, TYPE_STRUCT, src_pink_ElseIf)},
    [357] = NULL, // Func
    [358] = NULL, // Func
    [359] = NULL, // Func
    [360] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(158, TYPE_STRUCT, src_pink_SwitchCase)},
    [361] = NULL, // Func
    [362] = NULL, // Func
    [363] = NULL, // Func
    [364] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(41, TYPE_STRUCT, std_Map)},
    [365] = NULL, // Func
    [366] = NULL, // Func
    [367] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(16, TYPE_PTR, void *)},
    [368] = NULL, // Func
    [369] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(43, TYPE_PTR, src_pink_Package (**))},
    [370] = NULL, // No associated type
    [371] = NULL, // Func
    [372] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [31]), .align = alignof(char [31]), .base = TYPEID(3, TYPE_CHAR, char), .count = 31},
    [373] = NULL, // No associated type
    [374] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [45]), .align = alignof(char [45]), .base = TYPEID(3, TYPE_CHAR, char), .count = 45},
    [375] = NULL, // Func
    [376] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [23]), .align = alignof(char [23]), .base = TYPEID(3, TYPE_CHAR, char), .count = 23},
    [377] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [28]), .align = alignof(char [28]), .base = TYPEID(3, TYPE_CHAR, char), .count = 28},
    [378] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [44]), .align = alignof(char [44]), .base = TYPEID(3, TYPE_CHAR, char), .count = 44},
    [379] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(48, TYPE_PTR, src_pink_Sym (**))},
    [380] = NULL, // Func
    [381] = NULL, // Func
    [382] = NULL, // Func
    [383] = NULL, // Func
    [384] = NULL, // No associated type
    [385] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [26]), .align = alignof(char [26]), .base = TYPEID(3, TYPE_CHAR, char), .count = 26},
    [386] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [22]), .align = alignof(char [22]), .base = TYPEID(3, TYPE_CHAR, char), .count = 22},
    [387] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [54]), .align = alignof(char [54]), .base = TYPEID(3, TYPE_CHAR, char), .count = 54},
    [388] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [24]), .align = alignof(char [24]), .base = TYPEID(3, TYPE_CHAR, char), .count = 24},
    [389] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [39]), .align = alignof(char [39]), .base = TYPEID(3, TYPE_CHAR, char), .count = 39},
    [390] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(200, TYPE_PTR, src_pink_Type (**))},
    [391] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [37]), .align = alignof(char [37]), .base = TYPEID(3, TYPE_CHAR, char), .count = 37},
    [392] = NULL, // Func
    [393] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [36]), .align = alignof(char [36]), .base = TYPEID(3, TYPE_CHAR, char), .count = 36},
    [394] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [17]), .align = alignof(char [17]), .base = TYPEID(3, TYPE_CHAR, char), .count = 17},
    [395] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [47]), .align = alignof(char [47]), .base = TYPEID(3, TYPE_CHAR, char), .count = 47},
    [396] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [34]), .align = alignof(char [34]), .base = TYPEID(3, TYPE_CHAR, char), .count = 34},
    [397] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [41]), .align = alignof(char [41]), .base = TYPEID(3, TYPE_CHAR, char), .count = 41},
    [398] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [58]), .align = alignof(char [58]), .base = TYPEID(3, TYPE_CHAR, char), .count = 58},
    [399] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [16]), .align = alignof(char [16]), .base = TYPEID(3, TYPE_CHAR, char), .count = 16},
    [400] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [35]), .align = alignof(char [35]), .base = TYPEID(3, TYPE_CHAR, char), .count = 35},
    [401] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [38]), .align = alignof(char [38]), .base = TYPEID(3, TYPE_CHAR, char), .count = 38},
    [402] = NULL, // No associated type
    [403] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [53]), .align = alignof(char [53]), .base = TYPEID(3, TYPE_CHAR, char), .count = 53},
    [404] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(127, TYPE_NONE, src_pink_TokenKind)},
    [405] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [29]), .align = alignof(char [29]), .base = TYPEID(3, TYPE_CHAR, char), .count = 29},
    [406] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [48]), .align = alignof(char [48]), .base = TYPEID(3, TYPE_CHAR, char), .count = 48},
    [407] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [32]), .align = alignof(char [32]), .base = TYPEID(3, TYPE_CHAR, char), .count = 32},
    [408] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [55]), .align = alignof(char [55]), .base = TYPEID(3, TYPE_CHAR, char), .count = 55},
    [409] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [63]), .align = alignof(char [63]), .base = TYPEID(3, TYPE_CHAR, char), .count = 63},
    [410] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [14]), .align = alignof(char [14]), .base = TYPEID(3, TYPE_CHAR, char), .count = 14},
    [411] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [27]), .align = alignof(char [27]), .base = TYPEID(3, TYPE_CHAR, char), .count = 27},
    [412] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [60]), .align = alignof(char [60]), .base = TYPEID(3, TYPE_CHAR, char), .count = 60},
    [413] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [52]), .align = alignof(char [52]), .base = TYPEID(3, TYPE_CHAR, char), .count = 52},
    [414] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [46]), .align = alignof(char [46]), .base = TYPEID(3, TYPE_CHAR, char), .count = 46},
    [415] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [18]), .align = alignof(char [18]), .base = TYPEID(3, TYPE_CHAR, char), .count = 18},
    [416] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [20]), .align = alignof(char [20]), .base = TYPEID(3, TYPE_CHAR, char), .count = 20},
    [417] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [21]), .align = alignof(char [21]), .base = TYPEID(3, TYPE_CHAR, char), .count = 21},
    [418] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [42]), .align = alignof(char [42]), .base = TYPEID(3, TYPE_CHAR, char), .count = 42},
    [419] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [43]), .align = alignof(char [43]), .base = TYPEID(3, TYPE_CHAR, char), .count = 43},
    [420] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [51]), .align = alignof(char [51]), .base = TYPEID(3, TYPE_CHAR, char), .count = 51},
    [421] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [74]), .align = alignof(char [74]), .base = TYPEID(3, TYPE_CHAR, char), .count = 74},
    [422] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [100]), .align = alignof(char [100]), .base = TYPEID(3, TYPE_CHAR, char), .count = 100},
    [423] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [68]), .align = alignof(char [68]), .base = TYPEID(3, TYPE_CHAR, char), .count = 68},
    [424] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [73]), .align = alignof(char [73]), .base = TYPEID(3, TYPE_CHAR, char), .count = 73},
    [425] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [70]), .align = alignof(char [70]), .base = TYPEID(3, TYPE_CHAR, char), .count = 70},
    [426] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [64]), .align = alignof(char [64]), .base = TYPEID(3, TYPE_CHAR, char), .count = 64},
    [427] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [77]), .align = alignof(char [77]), .base = TYPEID(3, TYPE_CHAR, char), .count = 77},
    [428] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [57]), .align = alignof(char [57]), .base = TYPEID(3, TYPE_CHAR, char), .count = 57},
    [429] = NULL, // Func
    [430] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [67]), .align = alignof(char [67]), .base = TYPEID(3, TYPE_CHAR, char), .count = 67},
    [431] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [66]), .align = alignof(char [66]), .base = TYPEID(3, TYPE_CHAR, char), .count = 66},
    [432] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [92]), .align = alignof(char [92]), .base = TYPEID(3, TYPE_CHAR, char), .count = 92},
    [433] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [25]), .align = alignof(char [25]), .base = TYPEID(3, TYPE_CHAR, char), .count = 25},
    [434] = NULL, // Func
    [435] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [50]), .align = alignof(char [50]), .base = TYPEID(3, TYPE_CHAR, char), .count = 50},
    [436] = NULL, // Func
    [437] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(std_os_DirListIter), .align = alignof(std_os_DirListIter), .name = "std_os_DirListIter", .num_fields = 7, .fields = (TypeFieldInfo[]) {
        ...
        {"base", .type = TYPEID(139, TYPE_ARRAY, char [256]), .offset = offsetof(std_os_DirListIter, base)},
        {"name", .type = TYPEID(139, TYPE_ARRAY, char [256]), .offset = offsetof(std_os_DirListIter, name)},
    ...
    [438] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(437, TYPE_STRUCT, std_os_DirListIter)},
    [439] = NULL, // Func
    [440] = NULL, // Func
    [441] = NULL, // Func
    [442] = NULL, // Func
    [443] = NULL, // Func
    [444] = NULL, // Func
    [445] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [30]), .align = alignof(char [30]), .base = TYPEID(3, TYPE_CHAR, char), .count = 30},
    [446] = NULL, // Func
    [447] = NULL, // Func
    [448] = NULL, // Func
    [449] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(313, TYPE_PTR, src_pink_Decl (**))},
    [450] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [62]), .align = alignof(char [62]), .base = TYPEID(3, TYPE_CHAR, char), .count = 62},
    [451] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [49]), .align = alignof(char [49]), .base = TYPEID(3, TYPE_CHAR, char), .count = 49},
    [452] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(311, TYPE_PTR, src_pink_Typespec (**))},
    [453] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [69]), .align = alignof(char [69]), .base = TYPEID(3, TYPE_CHAR, char), .count = 69},
    [454] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(339, TYPE_PTR, src_pink_CompoundField *)},
    [455] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(342, TYPE_PTR, src_pink_Expr (**))},
    [456] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(118, TYPE_PTR, src_pink_Stmt (**))},
    [457] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(356, TYPE_PTR, src_pink_ElseIf *)},
    [458] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [59]), .align = alignof(char [59]), .base = TYPEID(3, TYPE_CHAR, char), .count = 59},
    [459] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(159, TYPE_PTR, src_pink_SwitchCasePattern *)},
    [460] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(360, TYPE_PTR, src_pink_SwitchCase *)},
    [461] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(318, TYPE_PTR, src_pink_EnumItem *)},
    [462] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(19, TYPE_PTR, char const ((**)))},
    [463] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(320, TYPE_PTR, src_pink_AggregateItem *)},
    [464] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [56]), .align = alignof(char [56]), .base = TYPEID(3, TYPE_CHAR, char), .count = 56},
    [465] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(324, TYPE_PTR, src_pink_FuncParam *)},
    [466] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(123, TYPE_PTR, src_pink_NoteArg *)},
    [467] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(179, TYPE_PTR, src_pink_Note *)},
    [468] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(328, TYPE_PTR, src_pink_ImportItem *)},
    [469] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [40]), .align = alignof(char [40]), .base = TYPEID(3, TYPE_CHAR, char), .count = 40},
    [470] = NULL, // Func
    [471] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(8, TYPE_INT, int)},
    [472] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(211, TYPE_STRUCT, src_pink_CachedArrayType)},
    [473] = NULL, // Func
    [474] = NULL, // Func
    [475] = NULL, // Func
    [476] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(213, TYPE_STRUCT, src_pink_CachedFuncType)},
    [477] = NULL, // Func
    [478] = NULL, // Func
    [479] = NULL, // Func
    [480] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [13]), .align = alignof(char [13]), .base = TYPEID(3, TYPE_CHAR, char), .count = 13},
    [481] = NULL, // Func
    [482] = NULL, // Func
    [483] = NULL, // Func
    [484] = NULL, // Func
    [485] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(4, TYPE_UCHAR, uchar)},
    [486] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [33]), .align = alignof(char [33]), .base = TYPEID(3, TYPE_CHAR, char), .count = 33},
    [487] = NULL, // Func
    [488] = NULL, // Func
    [489] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [101]), .align = alignof(char [101]), .base = TYPEID(3, TYPE_CHAR, char), .count = 101},
    [490] = NULL, // Func
    [491] = NULL, // Func
    [492] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(2, TYPE_BOOL, bool)},
    [493] = NULL, // Func
    [494] = NULL, // Func
    [495] = NULL, // Func
    [496] = NULL, // Func
    [497] = NULL, // Func
    [498] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [19]), .align = alignof(char [19]), .base = TYPEID(3, TYPE_CHAR, char), .count = 19},
    [499] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [80]), .align = alignof(char [80]), .base = TYPEID(3, TYPE_CHAR, char), .count = 80},
    [500] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [83]), .align = alignof(char [83]), .base = TYPEID(3, TYPE_CHAR, char), .count = 83},
    [501] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [81]), .align = alignof(char [81]), .base = TYPEID(3, TYPE_CHAR, char), .count = 81},
    [502] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [72]), .align = alignof(char [72]), .base = TYPEID(3, TYPE_CHAR, char), .count = 72},
    [503] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [114]), .align = alignof(char [114]), .base = TYPEID(3, TYPE_CHAR, char), .count = 114},
    [504] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [15]), .align = alignof(char [15]), .base = TYPEID(3, TYPE_CHAR, char), .count = 15},
    [505] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(301, TYPE_STRUCT, std_Arena)},
    [506] = NULL, // Func
    [507] = NULL, // Func
    [508] = NULL, // Func
    [509] = NULL, // Func
    ...
    [511] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(std_BufHdr), .align = alignof(std_BufHdr), .name = "std_BufHdr", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        ...
        {"buf", .type = TYPEID(258, TYPE_ARRAY, char [1]), .offset = offsetof(std_BufHdr, buf)},
    }},
    ...
    [517] = NULL, // Func
    [518] = NULL, // Func
    [519] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(dirent), .align = alignof(dirent), .name = "dirent", .num_fields = 2, .fields = (TypeFieldInfo[]) {
        {"d_name", .type = TYPEID(34, TYPE_PTR, char *), .offset = offsetof(dirent, d_name)},
        {"d_type", .type = TYPEID(4, TYPE_UCHAR, uchar), .offset = offsetof(dirent, d_type)},
    }},
    [520] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(519, TYPE_STRUCT, dirent)},
    [521] = NULL, // Func
    [522] = NULL, // Func
    [523] = NULL, // Func
    [524] = NULL, // Func
    [525] = NULL, // Incomplete: FILE
    [526] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID0(525, TYPE_NONE)},
    [527] = NULL, // Func
    [528] = NULL, // Func
    [529] = NULL, // Func
    [530] = NULL, // Func
    [531] = NULL, // Func
    [532] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(std_Intern), .align = alignof(std_Intern), .name = "std_Intern", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"len", .type = TYPEID(13, TYPE_ULLONG, ullong), .offset = offsetof(std_Intern, len)},
        {"next", .type = TYPEID(533, TYPE_PTR, std_Intern *), .offset = offsetof(std_Intern, next)},
        {"str", .type = TYPEID(258, TYPE_ARRAY, char [1]), .offset = offsetof(std_Intern, str)},
    }},
    [533] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(532, TYPE_STRUCT, std_Intern)},
    [534] = NULL, // Func
    [535] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(std_os_FlagDef), .align = alignof(std_os_FlagDef), .name = "std_os_FlagDef", .num_fields = 7, .fields = (TypeFieldInfo[]) {
        {"kind", .type = TYPEID(536, TYPE_NONE, std_os_FlagKind), .offset = offsetof(std_os_FlagDef, kind)},
        ...
        {"ptr", .type = TYPEID(537, TYPE_STRUCT, std_os_FlagDefPtr), .offset = offsetof(std_os_FlagDef, ptr)},
    }},
    [536] = NULL, // Enum
    [537] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(std_os_FlagDefPtr), .align = alignof(std_os_FlagDefPtr), .name = "std_os_FlagDefPtr", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        {"i", .type = TYPEID(471, TYPE_PTR, int *), .offset = offsetof(std_os_FlagDefPtr, i)},
        {"b", .type = TYPEID(492, TYPE_PTR, bool *), .offset = offsetof(std_os_FlagDefPtr, b)},
        {"s", .type = TYPEID(19, TYPE_PTR, char const ((**))), .offset = offsetof(std_os_FlagDefPtr, s)},
    }},
    [538] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(535, TYPE_STRUCT, std_os_FlagDef)},
    [539] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(538, TYPE_PTR, std_os_FlagDef *)},
    [540] = NULL, // Func
    [541] = NULL, // Func
    [542] = NULL, // Func
    [543] = NULL, // Func
    [544] = NULL, // Func
    [545] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(67, TYPE_PTR, char (**))},
    [546] = NULL, // Func
    [547] = NULL, // Func
    [548] = NULL, // Func
    [549] = NULL, // Func
    ...
    [576] = NULL, // Func
    [577] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(10, TYPE_LONG, long)},
    [578] = NULL, // Func
    [579] = NULL, // No associated type
    [580] = NULL, // No associated type
    [581] = NULL, // Func
    [582] = &(TypeInfo){TYPE_CONST, .size = sizeof(long const ), .align = alignof(long const ), .base = TYPEID(10, TYPE_LONG, long)},
    [583] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(582, TYPE_CONST, long const )},
    [584] = NULL, // Func
    [585] = NULL, // Func
    [586] = NULL, // Func
    [587] = NULL, // Func
    ...
    [609] = NULL, // Func
    [610] = NULL, // Func
    [611] = &(TypeInfo){TYPE_CONST, .size = sizeof(char (*const )), .align = alignof(char (*const )), .base = TYPEID(34, TYPE_PTR, char *)},
    [612] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(611, TYPE_CONST, char (*const ))},
    [613] = NULL, // Func
    ...
    [633] = NULL, // Func
    [634] = NULL, // Func
    [635] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(6, TYPE_SHORT, short)},
    [636] = NULL, // Func
    [637] = NULL, // Func
    [638] = NULL, // Func
    [639] = &(TypeInfo){TYPE_CONST, .size = sizeof(short const ), .align = alignof(short const ), .base = TYPEID(6, TYPE_SHORT, short)},
    [640] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(639, TYPE_CONST, short const )},
    [641] = NULL, // Func
    [642] = NULL, // Func
    [643] = NULL, // Func
    [644] = NULL, // Func
...
void std_os_dir_list_next(std_os_DirListIter (*iter)) {
    ...
    do {
        ...
        std_os_path_copy(iter->name, entry->d_name);
...
char const ((*std_os_parse_flags(int (*argc_ptr), char const ((*(*(*argv_ptr))))))) {
    ...
    *(argc_ptr) = (argc) - (i);
    *(argv_ptr) = (argv) + (i);
    return std_os_path_file(strdup(argv[0]));
}
